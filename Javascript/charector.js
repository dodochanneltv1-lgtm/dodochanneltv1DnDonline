...
function createCharacter() {
    ...
    // ✅ [ยืนยันความถูกต้อง] การกำหนดคีย์ Stat เป็นตัวพิมพ์ใหญ่ครบทุกตัว เพื่อให้สอดคล้องกับโครงสร้างข้อมูลใน Firebase
    ...
    const characterData = {
        ...
        exp: 0,
        expToNextLevel: 300, // EXP ที่ต้องการสำหรับเลเวลถัดไป
        stats: { baseRaceStats, baseClassStats, investedStats, tempStats },
        hp: maxHp, 
        maxHp: maxHp, // เพิ่มค่า maxHp เริ่มต้น
        inventory: [], 
        quest: null, 
        enemy: null,

        // --- [NEW] อัปเดตโครงสร้างช่องสวมใส่ ---
        equippedItems: {
            mainHand: null,
            offHand: null,
            head: null,
        ...
        // --- [NEW] เพิ่ม state ควบคุมการต่อสู้ ---
        combatControls: {
            canAttack: true, // เริ่มต้นมาโจมตีได้
            canRollDamage: false
        }
    };
